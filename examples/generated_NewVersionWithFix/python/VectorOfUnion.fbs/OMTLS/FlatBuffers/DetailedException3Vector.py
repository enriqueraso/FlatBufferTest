...
def Start(builder):
    return DetailedException3VectorStart(builder)
...
def AddAType(builder, aType):
    return DetailedException3VectorAddAType(builder, aType)
...
def StartATypeVector(builder, numElems):
    return DetailedException3VectorStartATypeVector(builder, numElems)
...
def AddA(builder, a):
    return DetailedException3VectorAddA(builder, a)
...
def StartAVector(builder, numElems):
    return DetailedException3VectorStartAVector(builder, numElems)
def DetailedException3VectorEnd(builder): return builder.EndObject()
def End(builder):
    return DetailedException3VectorEnd(builder)